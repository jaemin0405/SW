...
# 수박 추가 => append()메소드 사용
fruits.append('수박')
print("과일목록(수박 추가) : ", fruits)

fruits.append('망고')
print("과일목록(망고 추가) : ", fruits)
...
# 과일 리스트 중에서 제일 첫번째 과일은 무엇인가?
print("과일 리스트 중에서 제일 첫번째 과일은? ", fruits[0])

print("과일 리스트 중에서 제일 마지막 과일은? ", fruits[-1])

print("과일 리스트 중에서 가장 큰 과일은(사전적 순서)? ", max(fruits))

print("과일 리스트 중에서 가장 작은 과일은? ", min(fruits))

#오름차순 정렬
fruits.sort()
print("오름차순 정렬 : ", fruits)
# 내림차순 정렬
fruits.sort(reservese =  True)
...
print("과일 리스트 중 3번부터 마지막까지 과일은? ", fruits[2:1])

print("과일 리스트중 1,3,5번 과일은? ", fruits[::2])
...
fruits.remove('사과') # 처음으로 만나는 사과만 삭제
print("과일목록(사과 삭제) : ", fruits)
